...
set(frontier_bgfx_patch "${CMAKE_CURRENT_LIST_DIR}/bgfx-diagnostics.patch")
...
if(NOT frontier_bgfx_already_patched EQUAL 0)
    ...
    if(NOT frontier_bgfx_patch_check EQUAL 0)
        message(FATAL_ERROR
            "The city diagnostics patch does not match the pinned bgfx source. "
            "Review cmake/bgfx-diagnostics.patch when updating the dependency.\n"
